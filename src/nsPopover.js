        ...
        return {
          ...
          link: function(scope, elm, attrs) {
            ...
            var options = {
              ...
              otherOptions: $parse(attrs.nsPopoverOtherOptions) || defaults.otherOptions,
            };
            var placement_;
             ...
             */
            function move(popover, placement, align, rect, triangle, otherOptions) {
              var containerRect;
              ...
              if (placement === 'top') {
                top = rect.top - popoverRect.height - (otherOptions.padding || 0);
                left = positionX();
              } else if (placement === 'right') {
                top = positionY();
                left = rect.right + (otherOptions.padding || 0);
              } else if (placement === 'bottom') {
                top = rect.bottom + (otherOptions.padding || 0);
                left = positionX();
              } else if (placement === 'left') {
                top = positionY();
                left = rect.left - popoverRect.width - (otherOptions.padding || 0);
              }
            ...
            displayer_ = {
              ...
              display: function(delay, e) {
                ...
                displayer_.id_ = $timeout(function() {
                  ...
                  move($popover, placement_, align_, elmRect, $triangle, options.otherOptions(scope) || {});
                  addEventListeners();
